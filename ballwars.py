...
class PygView(object):
    ...
    def paint(self):
        ...
        self.bouncer1 = Bouncer(pos=v.Vec2d(600,0),move=v.Vec2d(100,0),color=(100,180,0),radius= 100,mass=10000,static = True,bounce_on_edge=True)
        self.bouncer2 = Bouncer(pos=v.Vec2d(600,PygView.height),move=v.Vec2d(100,0),color=(100,180,0),radius= 100,mass=10000,static = True,bounce_on_edge=True)
