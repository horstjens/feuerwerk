...
class Ufo_Mothership(VectorSprite):
    ...
    def _overwrite_parameters(self):
        self.bounce_on_edge = True
        self.dangerhigh = PygView.height * 0.20
...
class PygView(object):
    ...
    def new_wave(self):
        ...
        for x in range(PygView.level):
            Ufo_Mothership(pos=pygame.math.Vector2(random.randint(0,PygView.width),-50))
    ...
    def prepare_sprites(self):
        ...
        #self.mothership = Ufo_Mothership(pos=pygame.math.Vector2(random.randint(0,PygView.width),-50), color=(255,255,0))
    ...
    def menu_run(self):
        ...
        while running:
            ...
            for line_number, line in enumerate(Game.descr[self.active_item]):
                write(self.screen,line,x=PygView.width//2-500, y=300+line_number*50, color=(255,0,255))
            ...
            if t != "resume":
                i = Game.current_level[t]
                cost = Game.cost[t][i]
                write(self.screen, "Your Money: {}".format(self.money), x=PygView.width//2-500, y=100)
                write(self.screen, "Current value: {}".format(Game.level[t][i]), x=PygView.width//2-500,y=150)
                write(self.screen, "Improved value: {}".format(Game.level[t][i+1]), x=PygView.width//2-500, y=200)
                write(self.screen, "Cost: {}".format(cost), x=PygView.width//2-500, y=250) 
...
class PygView(object):
    ...
    def run(self):
        ...
        while running:
            ...
            # ----------- clear, draw , update, flip -----------------
            self.allgroup.draw(self.screen)
https://github.com/horstjens/feuerwerk/compare
