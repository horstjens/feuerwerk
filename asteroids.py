...
class PygView(object):
    ...
    def paint(self):
        ...
        self.player1 =  Spaceship(color = (0, 0, 255), warp_on_edge=True, pos=pygame.math.Vector2(PygView.width/2,-PygView.height/2))
        self.player2 =  Spaceship(color = (0, 255, 0), warp_on_edge=True,
                         pos=pygame.math.Vector2(PygView.width/2+ 200,-PygView.height/2), angle=180)
